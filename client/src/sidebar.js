        ...
        <aside ref={nav}>
            <div className="sidebar">
                ...
                <div className="appnav-container" ref={appnavRef}>
                    <button onClick={() => { navigate('/home'); toggleSideNavbar(setNavbarState(false)) }} id='home' className='side-btn'>
                ...
                <div className="personal-container" ref={personalRef}>
                    ...
                    <button onClick={() => { navigate('/'); toggleSideNavbar(setNavbarState(false)) }} className='side-btn'>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.25">
