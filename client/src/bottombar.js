...
const BottomBar = () => {
    ...
    const onplaying = () => {
        ...
        if (isPlaying) {
            ...
            if (calcProgress === 0) setProgressBar(0)
            else setProgressBar(calcProgress)
        }
    }
        ...
        <div className="bottombar">
            ...
            <div className="bottom-middle">
                <div className="current-controls">
                    ...
                    <button className='previous-btn' onClick={() => skipSong(false)}>
                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="bottom-right">
                <button onClick={() => audioEl.current.muted = !audioEl.current.muted}>
